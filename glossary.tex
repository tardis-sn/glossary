...
\newglossaryentry{starkit}{name=STARKIT, text=\textsc{starkit}, description= TARDIS MC code, first = {\textsc{starkit} \cite{wolfgang_kerzendorf_2015_28016}}}

\newglossaryentry{pyne}{name=PYNE, text=\textsc{pyne}, description= PYNE code, first = {\textsc{pyne} \cite{Scopatz2012a}}}
...
\newglossaryentry{wsynphot}{name=WSYNPHOT, text=\textsc{wsynphot}, description=MultiNest, first={\textsc{wsynphot} \protect\footnote{\url{https://github.com/wkerzendorf/wsynphot}}}}
\newglossaryentry{specutils}{name=SPECUTILS, text=\textsc{specutils}, description=specutils, first={\textsc{specutils} \protect\footnote{\url{https://github.com/astropy/specutils}}}}
